...
static const char qt_meta_stringdata_QTProject[] = {
    "QTProject\0"
};
...
const QMetaObjectExtraData QTProject::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QTProject::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_QTProject,
      qt_meta_data_QTProject, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QTProject::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QTProject))
