...
enum RAL_SHADERTYPE
{
	RAL_SHADERTYPE_VERTEXSHADER = 0,
	RAL_SHADERTYPE_PIXELSHADER,
	RAL_SHADERTYPE_HULLSHADER,
	RAL_SHADERTYPE_DOMAINSHADER,
	RAL_SHADERTYPE_GEOMETRYSHADER,
	RAL_SHADERTYPE_COMPUTESHADER,
	RAL_SHADERTYPE_COUNT,
	RAL_SHADERTYPE_NONE = RAL_SHADERTYPE_COUNT
};